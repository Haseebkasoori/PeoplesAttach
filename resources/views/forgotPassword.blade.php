                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            ...
                            <p style="margin:10px 0 10px 0;color:#565a5c;font-size:18px">We got a Request for New password</p>
                    ...
                    <tr>
                        <td>
                            <strong style="color:#ffff;text-decoration:none;display:block;width: 13em;text-align:center;background:#47a2ea;padding:0.5em;font-size:20px;margin-left: 4em; ">{{$details}}</strong>
                        </td>
                    </tr>
                </tbody>
            </table>
